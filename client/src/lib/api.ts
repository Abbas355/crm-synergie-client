...
import { ClientSelect, ClientInsert, SimCardSelect, SimCardInsert, TaskSelect, TaskInsert, UserSelect } from "@shared/schema";
...
// Fonction de requête API legacy pour compatibilité
