...
export type FormField = {
  ...
  label: string;
  required: boolean;
  section: "personnel" | "adresse" | "contrat" | "documents";
  validated: boolean;
};

// Propriétés du composant
type FormProgressTrackerProps = {
  fields: FormField[];
...
export function FormProgressTracker({
  ...
  useEffect(() => {
    ...
    const sections = ["personnel", "adresse", "contrat", "documents"];
  ...
  return (
    <div className="space-y-2 mb-6">
      ...
      <div className="flex justify-between mt-2">
        ...
        <SectionBadge 
          label="Documents" 
          progress={sectionProgress.documents} 
...
function FieldStatus({ field }: { field: FormField }) {
