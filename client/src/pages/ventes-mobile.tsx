...
export default function VentesMobilePage() {
        ...
        <div className="grid gap-6 grid-cols-2 mb-8">
          ...
          <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-500 mt-1">
                {sourcesData.length > 0 ? sourcesData.reduce((max, current) => current.value > max.value ? current : max, sourcesData[0])?.name || 'Aucune' : 'Aucune'}
              </p>
            </CardContent>
          </Card>
